...
import { ACTOR_ID } from '../ApifyGoogleTravelExplore.node';
import { buildActorInput } from '../ApifyGoogleTravelExplore.properties';
...
/**
 * Shape a single disclosed transaction according to the chosen Output mode.
...
function shapeItem(
	...
	return {
		...
		flightPrice: item.flight_price,
		hotelPrice: item.hotel_price,
		flightDuration: item.flight_duration,
		numberOfStops: item.number_of_stops,
