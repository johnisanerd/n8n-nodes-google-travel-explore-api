...
import { properties } from './ApifyGoogleTravelExplore.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'P4gbxfqolqaL1FzKr' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-travel-explore-api' as string;
export const CLASS_NAME = 'ApifyGoogleTravelExplore' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-travel-explore-app' as string;

export const DISPLAY_NAME = 'Google Travel Explore' as string;
export const DESCRIPTION =
	'Discover destinations from a departure airport with flight prices, hotel prices, and trip dates' as string;

export class ApifyGoogleTravelExplore implements INodeType {
